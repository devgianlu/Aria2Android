...
An Android app that lets you run [aria2](https://github.com/aria2/aria2) on your device. If you like this project you can donate some money with [Liberapay](https://liberapay.com/devgianlu/donate) or `bitcoin:1FFNhcCHBeyYroGuUQLWAXhE9Kg9qsfHZP`.
