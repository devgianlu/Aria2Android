...
public class DownloadBinActivity extends AppCompatActivity {
        ...
        new Thread(new AsyncRequest(getString(R.string.URL_releases), new IResponse() {
            ...
            public void onResponse(String response) {
                ...
                try {
                    ...
                    Utils.UIToast(DownloadBinActivity.this, Utils.TOAST_MESSAGES.FAILED_RETRIEVING_RELEASES, ex);
                    return;
                } finally {
                    pd.dismiss();
                }

                final AlertDialog.Builder builder = new AlertDialog.Builder(DownloadBinActivity.this);
                builder.setSingleChoiceItems(new ArrayAdapter<>(DownloadBinActivity.this, android.R.layout.simple_list_item_1, releasesList), 0, new DialogInterface.OnClickListener() {
                    @Override
                            ...
                            new Thread(new AsyncRequest(jReleases.getJSONObject(which).getString("url"), new IResponse() {
                                ...
                                public void onResponse(String response) {
                                    ...
                                    try {
                                        ...
                                        new DownloadFile(DownloadBinActivity.this).execute(new URL(downloadURL));
                                    } catch (Exception ex) {
                                        Utils.UIToast(DownloadBinActivity.this, Utils.TOAST_MESSAGES.FAILED_RETRIEVING_RELEASES, ex);
                                    }
                                }
